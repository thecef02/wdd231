    ...
    attractions: [
        {
            ...
            address: "2038 E Alpine Loop Rd, American Fork, UT 84003",
            description: "National Monument featuring spectacular limestone caves, guided tours, and scenic hiking trails in American Fork Canyon.",
            image: "timpanogos-cave-national-monument.webp"
        },
        {
            id: 2,
            name: "Mary & Art Dye Park",
            address: "1000 N 550 E St, American Fork, UT 84003",
            description: "One of the city's largest parks with sports fields, playgrounds, picnic areas, and walking paths.",
            image: "art-dye-park.webp"
        },
        {
            id: 3,
        ...
        },
        {
            ...
            address: "American Fork Canyon, UT",
            description: "Scenic mountain canyon known for hiking, camping, fishing, waterfalls, and fall colors.",
            image: "af-canyon-view.webp"
        }
    ]
};

export { afattractions };